...
public class Main {
    public static void main(String[] args) {
        ...
        int signalSpeed = 3;
        System.out.println(Arrays.toString(countPairsOfConnectableServers(edges, signalSpeed)));
    }
    ...
    public static int dfs(int src, int weight, int signalSpeed, Map<Integer, List<Integer[]>> graph, boolean visited[]){
        visited[src] = true;
        int count = 0;
